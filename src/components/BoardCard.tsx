...
export function CardArt({
	...
	const stroke = highlight ? palette.wheat : accent;
	...
	const frame = (content: React.ReactNode) => (
		...
		>
			...
			{/* Dedicated transparent hit target so clicks register reliably
			    regardless of the card's art/text children. */}
			<Rect
				width={CARD_W}
				height={CARD_H}
	...
	return frame(
		<>
			...
			/>
			{/* Procedural placeholder art: a tinted panel with a type label. */}
			<Rect
				y={30}
				width={CARD_W}
				height={CARD_H - 68}
